...
const phaseConfig = {
  ...
  ibadan: {
    heading: "🏛️ Wishes From Ibadan",
    subtitle:
      "Displaying wishes submitted from Ibadan as we celebrate in the city.",
    counterLabel: "wishes from Ibadan",
  },
  birthday: {
...
const WishesWall = () => {
  ...
  useEffect(() => {
    ...
    // Show only last 5 pre-birthday, all on birthday
    const q = isBirthday
  ...
  const displayedWishes = isVisitDay
    ? wishes.filter((w) => w.location.toLowerCase().includes("ibadan"))
    : wishes;
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {loading ? (
          ...
          >
            ...
            >
              {isVisitDay
                ? "No Ibadan wishes yet"
                : "Be the first to send a wish"}
            </h3>
            <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.9rem" }}>
              {isVisitDay
                ? "Wishes from Ibadan will appear here."
        ...
        {!isBirthday && displayedWishes.length > 0 && (
          ...
          >
            All wishes will be fully revealed to Prophet Sam Olu Alo on his
            birthday — 25th May 2026 🎂
          </motion.p>
        )}
      </div>
    </section>
